package gokenya.safari.com.networksync;
    ...
    public void checkConnection(){
        ...
        if(!isInternetConnected()) {
                ...
                final FancyAlertDialog.Builder alert = new FancyAlertDialog.Builder(ctx)
                        ...
                        .setTextSubTitle("Cannot connect to the servers of this page")
                        .setBody("Kindly connect to a WIFI network or enable Mobile Data")
